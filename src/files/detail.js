...
export var detail = [
  "Whenver we use this type of function with any event it call with its calling object 'this' & if we want to use the 'this' scope of component then we have to bind the calling fucntion with this in constructor ",
